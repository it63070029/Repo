...
?>
  <tr>
    ...
    <td><button type = "submit" class ="btn btn-light"><a href="delet.php?id=<?=$result['id'];?">Delete</a></button></td>
                <button type = "submit" class ="btn btn-light"><a href="edit.php?id=<?=$result['id'];?">Edit</button></td>
  </tr>
<?php
}
?>
